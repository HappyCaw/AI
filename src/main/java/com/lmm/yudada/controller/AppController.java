...
import com.lmm.yudada.model.dto.app.AppAddRequest;
import com.lmm.yudada.model.dto.app.AppEditRequest;
import com.lmm.yudada.model.dto.app.AppQueryRequest;
import com.lmm.yudada.model.dto.app.AppUpdateRequest;
...
public class AppController {
    ...
    public BaseResponse<Long> addApp(@RequestBody AppAddRequest appAddRequest, HttpServletRequest request) {
        ThrowUtils.throwIf(appAddRequest == null, ErrorCode.PARAMS_ERROR,"添加请求为空");
        // 在此处将实体类和 DTO 进行转换
        App app = new App();
        ...
        ThrowUtils.throwIf(!result, ErrorCode.OPERATION_ERROR,"写入数据库失败");
        // 返回新写入的数据 id
